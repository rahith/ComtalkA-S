...
//                                            addToCriteria(Restrictions.eq("fieldValue.value", fieldValue.getValue()))
    ...
    def save = {
        ...
        def contactFieldType = new ContactTypeDAS();
        params.contactField.each {field ->
        if (contactFieldType.find(Integer.valueOf(field.key)).dataType == 'Decimal'){
            try {
            if(field.value)
            ...
            flash.args = [contactFieldType.find(Integer.valueOf(field.key)).description,'Decimal']
             redirect action: 'edit' , params: [id : params.user.userId]
            }
        }
        else if (contactFieldType.find(Integer.valueOf(field.key)).dataType == 'Integer'){
            try {
            if(field.value)
            ...
            flash.args = [contactFieldType.find(Integer.valueOf(field.key)).description,'Integer']
            redirect action: 'edit' , params: [id : params.user.userId]
            }
        }
        else if (contactFieldType.find(Integer.valueOf(field.key)).dataType == 'Boolean'){
            ...
            flash.args = [contactFieldType.find(Integer.valueOf(field.key)).description,'Boolean']
            redirect action: 'edit' , params: [id : params.user.userId]
            }
        }
        }
